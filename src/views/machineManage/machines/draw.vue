<template>
  ...
  >
    <div v-if="show">
      <!-- 磁盘 -->
      <!--      <el-card v-loading="queryDiskLoading" class="box-card">-->
      <!--        <div class="grid-box">-->
      ...
      <!--                  :stroke-width="15"-->
      <!--                  :show-text="false"-->
      <!--                  :percentage="percentageUsed(item.usedSpace, item.totalSpace)"-->
      <!--                  type="line"-->
      <!--                />-->
      <!--              </div>-->
      <!--              <div class="item-right-3">{{ dataSizeFormate(item.usableSpace) }}可用，共 {{-->
      <!--                dataSizeFormate(item.totalSpace)-->
      <!--              }}-->
      <!--              </div>-->
      <!--            </div>-->
      <!--          </div>-->
      ...
      <el-card class="box-card">
        ...
        <el-form ref="form" :rules="rules" :model="form" v-if="this.$route.query.riskmode === 'true'"
          ...
          <!--          <el-form-item label="机械自P">-->
          <!--            <el-switch v-model="form.hddEnable" active-color="#13ce66" inactive-color="#ff4949" />-->
          <!--          </el-form-item>-->
          ...
          <el-form-item label="预资金占用">
            <el-input type="textarea" v-model="maxFees" autosize disabled style="max-width: 224px"/>
          </el-form-item>
          <el-form-item label=" ">
...
import {
  ...
  listBackTestSymbols, listSymbols
