<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-dialog append-to-body :close-on-click-modal="false" :visible.sync="profitDialogShow" title="盈亏信息"
                 width="280px">
      ...
      <el-table ref="table" v-loading="queryLoading" :data="machineList" size="small" stripe style="width: 100%;"
        ...
        <el-table-column label="操作" width="260px" align="center">
          <template slot-scope="scope">
            ...
            <!--            >-->
            <!--&lt;!&ndash;              @click="toBindingCard(scope.row.id)"&ndash;&gt;-->
            <!--              无用按钮-->
            <!--            </el-button>-->
            <el-button
              slot="reference"
...
import {
  ...
  checkEquity,
  updateRemark,
  queryProfit, balance, createStrategy
...
export default {
  ...
  methods: {
    ...
    queryList() {
      ...
      list(this.queryShareListParam).then(res => {
    ...
    checkEquity(clientId) {
      ...
      // }).catch(() => {
      // })
      this.$router.push({path: '/strategy/detail?share=true', query: {clientId: clientId}})
    },
    toRemark(row) {
